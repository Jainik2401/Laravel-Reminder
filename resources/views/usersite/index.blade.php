            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-6">
                    <div class="text-center my-5">
                        <h1 class="display-5 fw-bolder text-white mb-2">A Reminder E-mail </h1>
                        <p class="lead text-white-50 mb-4">There are two reminders:<br> Tasks Reminder and Events
                            Reminder</p>
                        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center">
                            <a class="btn btn-primary btn-lg px-4 me-sm-3" href="reminder.html">Get Started</a>
                        </div>
                    </div>
                </div>
            </div>
